...
class Config:
    ...
    def require_api_key(self, key_name, key_description, is_required):
        ...
        if is_required and not key_exists:
            # Новая логика: выводим ошибку и завершаем программу
            print(f"ОШИБКА: Необходимый API-ключ '{key_name}' не найден в переменных окружения.")
            sys.exit("Программа остановлена. Пожалуйста, убедитесь, что ваш .env файл настроен правильно.")
